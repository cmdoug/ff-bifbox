...
```sh
ff-mpirun -np 4 basecontinue.md -fi <FILEIN> -param <PARAM>
```

### Continue input file along parameter with mesh adaptation:
```sh
ff-mpirun -np 4 basecontinue.md -fi <FILEIN> -param <PARAM> -mo <MESHOUT>
```

NOTE: This file should not be changed unless you know what you're doing.

SEE ALSO: [basecompute.md](./basecompute.md), [basedeflate.md](./basedeflate.md), [modecompute.md](./modecompute.md)
