...
```sh
ff-mpirun -np 4 tdlscompute.md -fi <FILEIN> -fo <FILEOUT>
```

NOTE: This file should not be changed unless you know what you're doing.

SEE ALSO: [basecompute.md](./basecompute.md), [basecontinue.md](./basecontinue.md), [modecompute.md](./modecompute.md), [rslvcompute.md](./rslvcompute.md), [respcompute.md](./respcompute.md), [tdnscompute.md](./tdnscompute.md)
