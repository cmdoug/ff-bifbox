...
ff-mpirun -np $nproc basecompute.edp -v 0 -dir $workdir -fi buckling_1.base -fo buckling_A -P 0.05 -tgv -2
...
ff-mpirun -np $nproc modecompute.edp -v 0 -dir $workdir -fi "$out".fold -so buckling -fo buckling_B -eps_target 0.1+0i -eps_nev 3 -eps_gen_hermitian -sym 1
