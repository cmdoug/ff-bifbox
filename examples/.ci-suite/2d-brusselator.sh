...
# build meshes
FreeFem++-mpi -v 0 examples/.ci-suite/2d-brusselator_mesh.md -mo $workdir/square
# LINEAR STABILITY ANALYSIS OF CONSTANT SOLUTION
ff-mpirun -np $nproc modecompute.md -v 0 -dir $workdir -mi square.msh -fo oe -A 2 -B 5.45 -Dx 0.008 -Dy 0.004 -1/L^2 0.25 -eps_target 0.3+2.1i -eps_nev 5 -eps_pos_gen_non_hermitian -sym 0,0
ff-mpirun -np $nproc modecompute.md -v 0 -dir $workdir -mi square.msh -fo ee -A 2 -B 5.45 -Dx 0.008 -Dy 0.004 -1/L^2 0.25 -eps_target 0.3+2.1i -eps_nev 5 -eps_pos_gen_non_hermitian -sym 1,0
# COMPUTE HOPF POINTS
ff-mpirun -np $nproc hopfcompute.md -v 0 -dir $workdir -fi oe.mode -fo brusselator10 -param 1/L^2 -snes_rtol 0
ff-mpirun -np $nproc hopfcompute.md -v 0 -dir $workdir -fi ee.mode -fo brusselator20 -param 1/L^2 -snes_rtol 0
ff-mpirun -np $nproc hopfcompute.md -v 0 -dir $workdir -fi oe_2.mode -fo brusselator30 -param 1/L^2 -snes_rtol 0
# CONTINUE HOPF POINT
...
ff-mpirun -np $nproc floqcompute.md -v 0 -dir $workdir -fi brusselator_branch-0.porb -so brusselator_branch-0 -eps_target 0.3+2.1i -sym 0,0 -eps_pos_gen_non_hermitian -eps_nev 5 -blocks 1
ff-mpirun -np $nproc floqcompute.md -v 0 -dir $workdir -fi brusselator_branch-0.porb -so brusselator_branch-0 -eps_target 0.3+2.1i -sym 1,0 -eps_pos_gen_non_hermitian -eps_nev 5 -blocks 2
