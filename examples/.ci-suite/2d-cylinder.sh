...
ff-mpirun -np $nproc meshcompute.md -v 0 -dir $workdir -fi cylinder50.base -fi0 cylinder.hopf -mo meshtest -adaptto bda -fi2 cylinderadapt_wnl_AA.mode -fi6 cylinderadapt_wnl_AAs.mode
