...
ff-mpirun -np $nproc basecontinue.md -v 0 -dir $workdir -fi cylinder_0.base -fo cylinder -h0 -1 -param 1/Re -paramtarget 0.021 -maxcount 10 -mo cylinder -scount 1 -thetamax 1e-6
...
ff-mpirun -np $nproc hopfcompute.md -v 0 -dir $workdir -fi cylinder.hopf -fo cylinderadapt -mo cylinderhopf -adaptto bo -param 1/Re -wnl 1 -thetamax 1e-6
