# jet_inject_confined.md
Author: Chris Douglas ([@cmdoug](https://github.com/cmdoug)) [christopher.douglas@duke.edu](mailto:christopher.douglas@duke.edu)

This file can be used with FreeFEM to create a mesh for the axially-injected, radially-confined jet as in [Douglas & Lesshafft. JFM, (2022)](https://doi.org/10.1017/jfm.2022.589).
...
string meshout = getARGV("-mo", "jet_inject_confined.msh"); // mesh filename
...
border C11(t=0, 1){x = 0; y = Rw - (Rw - 0.5 - deltaw)*t; label = BCinternal;}
