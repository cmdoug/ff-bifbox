# jet_inject_unconfined.md
Author: Chris Douglas ([@cmdoug](https://github.com/cmdoug)) [christopher.douglas@duke.edu](mailto:christopher.douglas@duke.edu)

This file can be used with FreeFEM to create a mesh for the axially-injected, radially-unconfined jet as in [Douglas & Lesshafft. JFM, (2022)](https://doi.org/10.1017/jfm.2022.589).
...
string meshout = getARGV("-mo", "jet_inject_unconfined.msh"); // mesh filename
...
border C09(t=0, 1){x = 0.0; y = Rinf - (Rinf - 0.5 - deltaw)*t; label = BCinternal;}
// Assemble mesh
mesh Thg = buildmesh(C01(0.5*n0) + C02((Rinf + l)*n1) + C03(Rinf*pi/2.0*n2) + C04(Xw*n2) + C05((Rinf - 0.5 - deltaw)*n1) + C06(Xw*n0) + C07(deltaw*n0) + C08(l*n0) + C09((Rinf - 0.5 - deltaw)*n1));
