...
This FreeFEM script is provided in the supplementary material for the article:
      
"A Balanced Outflow Boundary Condition for Open Swirling Flows" by Christopher M. Douglas.

It may be executed using FreeFEM by running the command: `FreeFem++ example1_suppmat.md`

The script parameters may be altered by additionally providing the following command-line arguments:
