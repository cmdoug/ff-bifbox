...
& + \left(\check{T},\frac{1}{T}\left[\frac{\partial T}{\partial t} + u_i\frac{\partial T}{\partial x_i} - \Delta TDa Y\exp\left\lbrace Ze\left(1+\frac{1}{\Delta T}\right)\left(1-\frac{1+\Delta T}{T}\right)\right\rbrace\right]\right)_{\Omega} + \left(\frac{\partial \check{T}}{\partial x_i},\frac{T^{2/3}}{Re Pr}\frac{\partial T}{\partial x_i}\right)_{\Omega} \\
