...
ff-mpirun -np $nproc meshcompute.md -v 0 -dir $workdir -fi methanol_"$wallBC"_Ra20000.mode -fi2 methanol_"$wallBC"_Ra20000adj.mode -anisomax 2 -hmax 1.0 -mo methanol_"$wallBC"_Re20000_adapt
