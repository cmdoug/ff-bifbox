...
```sh
ff-mpirun -np 4 tdnscompute.md -fi <FILEIN> -fo <FILEOUT>
```

### Compute time-domain nonlinear simulation with IC from input file with mesh adaptation:
```sh
ff-mpirun -np 4 tdnscompute.md -fi <FILEIN> -fo <FILEOUT> -mo <MESHOUT>
```

NOTE: This file should not be changed unless you know what you're doing.

SEE ALSO: [basecompute.md](./basecompute.md), [porbcompute.md](./porbcompute.md), [modecompute.md](./modecompute.md), [rslvcompute.md](./rslvcompute.md), [respcompute.md](./respcompute.md), [tdlscompute.md](./tdlscompute.md)
