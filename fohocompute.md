...
$$
\begin{align*}
\frac{dY}{dt} &= \alpha_1 \cdot \delta\lambda Y + \mathrm{i} \omega Y + \beta_1 Y \lvert Y \rvert^2 + \gamma_{12} Y Z + \gamma_{13} Y Z^2 \\
\frac{dZ}{dt} &= \alpha_2 \cdot \delta\lambda + \beta_{22} Z^2 + \beta_{23} Z^3 + \gamma_{22} \lvert Y \rvert^2 + \gamma_{23} Z \lvert Y \rvert^2
\end{align*}
$$
